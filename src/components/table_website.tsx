        ...
        <div className="flex  gap-10 justify-between items-start self-center max-w-full">
          <div className="flex flex-col min-w-[240px] max-md:max-w-full">
            <div className="text-xl  font-medium tracking-tighter max-md:max-w-full max-md:leading-[24px] text-[#141718]">
              ...
              <span className="font-semibold text-[#CD2027]">Website</span>{" "}
      ...
      <div className="mx-1 flex flex-col flex-1 shrink justify-start min-w-[240px]  shadow-[0px_4px_10px_rgba(0,0,0,0.6)] p-8  bg-white rounded-[20px]">
        ...
        <ul className="mt-2 text-sm ">
          <div>
            ...
            <li className="li">
              Data giới hạn{" "}
              <span className="text-[#CE2127] font-bold">5GB</span>
            </li>
       ...
       <div className="mx-1 flex flex-col flex-1 shrink justify-start min-w-[240px]  shadow-[0px_4px_10px_rgba(0,0,0,0.6)] p-8  bg-white rounded-[20px]">
        ...
        <p className="mt-2 text-sm  text-center font-semibold">
         Thiết kế website thông tin nâng cao,
 bán hàng cơ bản theo mẫu có sẵn
        </p>
        <ul className="mt-2 text-sm ">
          <div>
            <li className="li">
            ...
            <li className="li">
              Data giới hạn{" "}
              <span className="text-[#CE2127] font-bold">10GB</span>
            </li>
            <li className="li">Giao diện chuẩn UX/UI</li>
            <li className="li">Tối ưu giao diện máy tính</li>
            <li className="li">Tối ưu giao diện điện thoại</li>
             <li className="li">Hỗ trợ thiết kế logo, banner</li>
              <li className="li">
            Hỗ trợ setup <span className="text-[#CE2127] font-bold">1</span> chiến dịch Google Ads
            </li>
            <li className="li">
              Bảo hành miễn phí{" "}
              <span className="text-[#CE2127] font-bold">1</span> năm
...
theo mẫu có sẵn
        ...
        <ul className="mt-2 text-sm ">
          <div>
            ...
            <li className="li">
              Data giới hạn{" "}
              <span className="text-[#CE2127] font-bold">15GB</span>
            </li>
            <li className="li">Giao diện chuẩn UX/UI</li>
            <li className="li">Tối ưu giao diện máy tính</li>
            <li className="li">Tối ưu giao diện điện thoại</li>
             <li className="li">Hỗ trợ thiết kế logo, banner</li>
              <li className="li">
            Hỗ trợ setup <span className="text-[#CE2127] font-bold">2</span> chiến dịch Google Ads
            </li>
            <li className="li">
              Bảo hành miễn phí{" "}
              <span className="text-[#CE2127] font-bold">1</span> năm
    ...
    Thiết kế website theo yêu cầu
        ...
        <ul className="mt-2 text-sm ">
          <div>
            ...
            <li className="li">
              Data giới hạn{" "}
              <span className="text-[#CE2127] font-bold">20GB</span>
            </li>
            <li className="li">Giao diện chuẩn UX/UI</li>
            <li className="li">Tối ưu giao diện máy tính</li>
            <li className="li">Tối ưu giao diện điện thoại</li>
             <li className="li">Hỗ trợ thiết kế logo, banner</li>
              <li className="li">
            Hỗ trợ setup <span className="text-[#CE2127] font-bold">5</span> chiến dịch Google Ads
            </li>
            <li className="li">
              Bảo hành miễn phí
              <span className="text-[#CE2127] font-bold"> 1</span> năm
